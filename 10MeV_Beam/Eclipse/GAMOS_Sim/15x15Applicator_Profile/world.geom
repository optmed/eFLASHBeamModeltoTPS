...
// 10MeV Electron BEAM GENERATION
...
// CREATE ELECTRON APPLICATOR Piece
:P z06Cutout 93.5*cm
:P Cutout_z 1.50*cm 
:VOLU Cutout1 BOX 11.25*cm 30.0*cm ($Cutout_z/2) Cerrobend
:PLACE Cutout1 1 world RM0 187.5*mm 0.0*mm ($z06Cutout+$Cutout_z/2)
:COLOR Cutout1 0.4 0.8 1.0
:VIS Cutout1 ON

:VOLU Cutout2 BOX 11.25*cm 30.0*cm ($Cutout_z/2) Cerrobend
:PLACE Cutout2 1 world RM0 -187.5*mm 0.0*mm ($z06Cutout+$Cutout_z/2)
:COLOR Cutout2 0.4 0.8 1.0
:VIS Cutout2 ON


:VOLU Cutout3 BOX 7.5*cm 11.25*cm ($Cutout_z/2) Cerrobend
:PLACE Cutout3 1 world RM0 0*mm 187.5*mm ($z06Cutout+$Cutout_z/2)
:COLOR Cutout3 0.4 0.8 1.0
:VIS Cutout3 ON


:VOLU Cutout4 BOX 7.5*cm 11.25*cm ($Cutout_z/2) Cerrobend
:PLACE Cutout4 1 world RM0 0*mm -187.5*mm ($z06Cutout+$Cutout_z/2)
:COLOR Cutout4 0.4 0.8 1.0
:VIS Cutout4 ON
...
:VOLU container BOX 175.*mm 175.*mm 75.*mm G4_WATER
:VOLU voxel BOX 0.5*mm 0.5*mm 0.5*mm G4_WATER
:VIS voxel OFF
:PLACE container 1 world RM0 0. 0. 1075.
:PLACE_PARAM voxel 1 container PHANTOM 350. 350. 150. 1. 1. 1.
