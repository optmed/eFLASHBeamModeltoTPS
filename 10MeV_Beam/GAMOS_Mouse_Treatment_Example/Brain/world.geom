...
:P z06Cutout 93.5*cm
:P Cutout_z 1.50*cm 
:VOLU Cutout TUBE 0.75*cm 30.0*cm ($Cutout_z/2) Cerrobend
...
//:VOLU container BOX 25.*mm 25.*mm 25.*mm G4_WATER
//:VOLU voxel BOX 0.5*mm 0.5*mm 0.5*mm G4_WATER
//:VIS voxel OFF
//:PLACE container 1 world RM0 0. 0. 1025.
//:PLACE_PARAM voxel 1 container PHANTOM 50. 50. 50. 1. 1. 1.
